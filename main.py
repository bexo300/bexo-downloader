...
async def choose_action(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ تعليمات مفصلة لكل زر
    prompts = {
        "📎 دمج PDF": (
            "📤 **تعليمات دمج PDF:**\n\n"
            "1️⃣ أرسل ملفات PDF واحدة تلو الأخرى\n"
        ...
        "🖼️ صور لـ PDF": (
            "🖼️ **تعليمات تحويل الصور إلى PDF:**\n\n"
            "1️⃣ أرسل الصور كـ **ملفات (Documents)**\n"
            "   ❌ وليس كصور (Photos)\n"
            "   ✅ اختر 'إرسال كملف' من قائمة المشاركة\n"
            "2️⃣ أرسلها واحدة تلو الأخرى\n"
            "3️⃣ بعد إرسال جميع الصور، اضغط 'إنهاء العملية'\n"
            "4️⃣ اختر اسم ملف PDF النهائي\n\n"
            "📌 الصيغ المدعومة: JPG, PNG, WEBP, BMP, TIFF"
        ),
        
        "📸 استخراج صور": (
            "📸 **تعليمات استخراج الصور من PDF:**\n\n"
            "1️⃣ أرسل ملف PDF واحد فقط\n"
            "2️⃣ اضغط 'إنهاء العملية'\n"
            "3️⃣ اختر اسم الملف النهائي\n\n"
            "📌 النتيجة:\n"
            "• صفحة واحدة → صورة JPG واحدة\n"
            "• عدة صفحات → ملف ZIP يحتوي على جميع الصور"
        ),
        
        "🔢 ترقيم الصفحات": (
            "🔢 **تعليمات ترقيم الصفحات:**\n\n"
            "1️⃣ أرسل ملف PDF واحد فقط\n"
            "2️⃣ اضغط 'إنهاء العملية'\n"
            "3️⃣ اختر اسم الملف النهائي\n\n"
        ...
        "✂️ تقسيم": (
            "✂️ **تعليمات تقسيم PDF:**\n\n"
            "1️⃣ أرسل ملف PDF واحد فقط\n"
            "2️⃣ أدخل نطاق الصفحات المطلوبة\n"
            "   مثال: `1-5,7,10`\n"
            "   • `1-5` → صفحات 1 إلى 5\n"
            "   • `7` → صفحة 7 فقط\n"
            "   • `10` → صفحة 10 فقط\n"
            "3️⃣ اضغط 'إنهاء العملية'\n"
            "4️⃣ اختر اسم الملف النهائي\n\n"
            "📌 سيتم استخراج الصفحات المحددة فقط"
        ),
        
        "🗑️ حذف صفحات": (
            "🗑️ **تعليمات حذف صفحات:**\n\n"
            "1️⃣ أرسل ملف PDF واحد فقط\n"
            "2️⃣ أدخل الصفحات المراد حذفها\n"
            "   مثال: `1,3-5,8`\n"
            "   • `1` → حذف صفحة 1\n"
            "   • `3-5` → حذف صفحات 3 إلى 5\n"
            "   • `8` → حذف صفحة 8\n"
            "3️⃣ اضغط 'إنهاء العملية'\n"
            "4️⃣ اختر اسم الملف النهائي\n\n"
            "📌 سيتم حذف الصفحات المحددة من الملف"
        ),
        ...
        "📉 ضغط": (
            ...
            "3️⃣ اختر اسم الملف النهائي\n\n"
            "📌 النتيجة:\n"
            "• سيتم تقليل حجم الملف\n"
            "• ستظهر نسبة التخفيض بعد المعالجة\n"
            "• إذا كان الملف مضغوطاً بالفعل، لن يتغير الحجم"
        ),
        
        "🔒 حماية": (
            "🔒 **تعليمات حماية PDF بكلمة مرور:**\n\n"
            "1️⃣ أرسل ملف PDF واحد فقط\n"
            "2️⃣ أدخل كلمة المرور (4 أحرف على الأقل)\n"
            "3️⃣ اضغط 'إنهاء العملية'\n"
            "4️⃣ اختر اسم الملف النهائي\n\n"
            "📌 سيتم تشفير الملف بكلمة المرور التي أدخلتها"
        ),
        
        "🔓 إزالة الحماية": (
            "🔓 **تعليمات إزالة الحماية من PDF:**\n\n"
            "1️⃣ أرسل ملف PDF مشفر واحد فقط\n"
            "2️⃣ اضغط 'إنهاء العملية'\n"
            "3️⃣ اختر اسم الملف النهائي\n\n"
            "📌 ملاحظة:\n"
            "• يعمل فقط مع الملفات غير المحمية بكلمة مرور\n"
            "• إذا كان الملف محمياً بكلمة مرور، لن يعمل"
        )
    }
